...
{% include figure.html
  class="right"
  width="33%"
  caption="A photo of crystalline insulin (which doctors dissolved in liquid to replicate the hormone) from Johns Hopkins Univerisity"
  image-path="/assets/images/crystalin.png" %}
